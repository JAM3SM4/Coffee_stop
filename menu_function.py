...
def menu(choices, title="James' Menu", prompt="Choose your item: "):
    print(title)
    print(len(title) * '-')
    i = 1
    for c in choices:
...
drink = menu(drinks)
flavor = menu(flavors, "James' flavors", "Choose your flavor: ")
topping = menu(toppings, "James' toppings", "Choose your topping: ")
